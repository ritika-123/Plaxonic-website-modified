...
<div id="carousel-fade" class="carousel slide carousel-fade" data-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      ...
      <div class="carousel-caption  animated slideInRight">
        ...
        <div class="carousel-img img-fluid animated slideInRight">
        <img src="images/banner-2nd-img.png">
    </div>
    ...
    <div class="carousel-item">
     ...
     <div class="carousel-item">
      ...
      <div class="carousel-caption animated slideInRight">
        ...
        <div class="carousel-img img-fluid animated slideInUp">
       <img src="images/banner-4th-image.webp">
   </div>
     <div class="img-move">
  ...
  <a class="carousel-control-prev" href="#carousel-fade" role="button" data-slide="prev">
    <span class="carousel-control-prev-icon" aria-hidden="true"><i class="flaticon-back"></i></span>
   </a>
  <a class="carousel-control-next" href="#carousel-fade" role="button" data-slide="next">
    <span class="carousel-control-next-icon" aria-hidden="true"><i class="flaticon-next"></i></span>
